...
class UidsapPolicy
{
    ...
    {
        return $user->can('view_any_uidsap');
    }

    /**
     * Determine whether the user can view the model.
     */
    public function view(User $user, Uidsap $uidsap): bool
    {
        return $user->can('view_uidsap');
    }
    ...
    {
        return $user->can('create_uidsap');
    }

    /**
     * Determine whether the user can update the model.
     */
    public function update(User $user, Uidsap $uidsap): bool
    {
        return $user->can('update_uidsap');
    }

    /**
     * Determine whether the user can delete the model.
     */
    public function delete(User $user, Uidsap $uidsap): bool
    {
        return $user->can('delete_uidsap');
    }
    ...
    {
        return $user->can('delete_any_uidsap');
    }
